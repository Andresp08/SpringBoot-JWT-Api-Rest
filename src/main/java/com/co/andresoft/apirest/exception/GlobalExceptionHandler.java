...
import com.co.andresoft.apirest.dto.ErrorDetalles;

//maneja todas las capturas de excepciones de la app
@ControllerAdvice
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler{
	...
	//si los datos del postmapping que le envio no es @Valido
	@Override
